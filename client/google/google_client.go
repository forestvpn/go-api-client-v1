...
func (a *Client) VerifyGooglePlayPurchase(params *VerifyGooglePlayPurchaseParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*VerifyGooglePlayPurchaseOK, error) {
	...
	if params == nil {
		params = NewVerifyGooglePlayPurchaseParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "VerifyGooglePlayPurchase",
		Method:             "POST",
		PathPattern:        "/google/verify-purchase/",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &VerifyGooglePlayPurchaseReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*VerifyGooglePlayPurchaseOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*VerifyGooglePlayPurchaseDefault)
