...
func (a *Client) GetTraffic(params *GetTrafficParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetTrafficOK, error) {
	...
	if params == nil {
		params = NewGetTrafficParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetTraffic",
		Method:             "GET",
		PathPattern:        "/usage/traffic/",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetTrafficReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetTrafficOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetTrafficDefault)
