...
func (o *CreateProfileParams) WithRequest(request *models.WireGuardProfileCreateRequest) *CreateProfileParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the create profile params
func (o *CreateProfileParams) SetRequest(request *models.WireGuardProfileCreateRequest) {
	o.Request = request
}
